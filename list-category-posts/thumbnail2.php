...
$lcp_display_output .= '<ul class="thumbnails">';
...
foreach ($this->catlist->get_categories_posts() as $single):
    ...
    $lcp_display_output .= "<div class='span4'><li><div class='thumbnail'>";
     ...
     */
    $lcp_display_output .= $this->get_excerpt($single, 'p', 'caption');


	$lcp_display_output .= '<a href="' . get_permalink($single) . '">more...</a>';
    ...
    $lcp_display_output .= '</div></div></li>';
	 ...
	 if (++$lcp_row_count==2) {
		$lcp_row_count = 0;
		$lcp_display_output .= "</ul></div><div class='row'><ul class='thumbnails'>";
	 }
endforeach;
